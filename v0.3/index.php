    ...
    <div class="container">
        ...
        <thead>
          <tr>
            ...
            <th class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo $engine['image']; ?></th>
            <th class="col-xs-7 col-sm-7 col-md-7 col-lg-7"><?php echo $engine['name']; ?></th>
            <th class="col-xs-2 col-sm-2 col-md-2 col-lg-2"><?php echo $engine['val']; ?> (<?php echo $engine['cost']; ?>)</th>
          </tr>
        </thead>
        <tbody>
          <!--<tr>
            ...
            <tr>
                ...
                <td>%s</td>
            </tr>',$mysqlfetcharray['id'],$mysqlfetcharray['img'],$mysqlfetcharray['name'],$mysqlfetcharray['id'],$mysqlfetcharray['id'],$mysqlfetcharray['name'],$mysqlfetcharray['warn'],$mysqlfetcharray['id'],$mysqlfetcharray['description'],$mysqlfetcharray['cost']);   
      ...
      <form class="form-inline" role="form" action="buy.php" method="post">
          <div class="form-group">
                <label class="sr-only"><?php echo $engine['email']; ?></label>
          ...
          <div class="form-group">
                ...
                <select class="form-control" name="good">
                    <?php
                            $selectall1 = mysql_query("SELECT * FROM `goods` WHERE `perm`='can'");
          ...
          <button type="submit" class="btn btn-default"><?php echo $engine['buy']; ?> <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span></button>
        </form>
    </div>
